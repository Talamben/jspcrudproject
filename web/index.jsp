...
<html>
    ...
    <body>
        <h1 class="ui header w3-margin w3-text-khaki">JSP Project CRUD</h1>
        ...
        <div class="footer">
           <div class="footer-social">
            <a href="https://github.com/Talamben" target="blank"><i class="ui icon github w3-text-blue"></i></a>
            <a class="phone" href="#" data-content="+2547187393312" data-variation="inverted">
                <i class="ui icon phone w3-text-green"></i>
            </a>
            <a href="https://www.facebook.com/benedicttalam.happyben" target="blank"><i class="ui icon facebook f w3-text-blue"></i></a>
            <a href="https://wa.me/+254718393312" target="blank"><i class="ui icon whatsapp w3-text-green"></i></a>
          </div>
          <div class="footer-text">
            <p><a href="index.jsp">Benedict Talam </a> &copy; 2022</p>
          </div>
        </div>
        <!-- End footer-->
    </body>
